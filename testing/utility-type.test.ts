...
describe("Readonly", () => {
    test("DeepReadonly for objects", () => {
        expectTypeOf<
            DeepReadonly<{ foo: string; bar: number }>
        >().toEqualTypeOf<{ readonly foo: string; readonly bar: number }>();
        expectTypeOf<
            DeepReadonly<{ foo: string; bar: { foo: number } }>
        >().toEqualTypeOf<{
            readonly foo: string;
            readonly bar: { readonly foo: number };
        }>();
        expectTypeOf<
            DeepReadonly<{ foo: { bar: string }; bar: { foo: number } }>
        >().toEqualTypeOf<{
...
describe("TupleToUnion", () => {
    test("Create union type", () => {
        expectTypeOf<TupleToUnion<["foo", "bar"]>>().toEqualTypeOf<
            "foo" | "bar"
        >();
        expectTypeOf<TupleToUnion<[1, 2]>>().toEqualTypeOf<1 | 2>();
        expectTypeOf<TupleToUnion<["foo", 1, "bar", 2]>>().toEqualTypeOf<
            "foo" | "bar" | 1 | 2
        >();
    });
});
...
describe("Properties with keyof", () => {
    test("Combines keys of two object types", () => {
        expectTypeOf<
            Properties<{ a: number }, { a: string }>
        >().toEqualTypeOf<"a">();
        expectTypeOf<Properties<{ a: number }, { b: string }>>().toEqualTypeOf<
            "a" | "b"
        >();
        expectTypeOf<
            Properties<{ a: number }, { b: string; c: number }>
        >().toEqualTypeOf<"a" | "b" | "c">();
    });
});
...
describe("Merge values", () => {
    test("Union two object types", () => {
        expectTypeOf<Merge<{ a: number }, { b: string }>>().toEqualTypeOf<{
            a: number;
            b: string;
        }>();
        expectTypeOf<
        ...
        expectTypeOf<
            Merge<{ a: number }, { a: string; b: string }>
    ...
    test("Extract property from object", () => {
        expectTypeOf<
            FlattenProperties<
                ...
                "address"
            >
        >().toEqualTypeOf<{ name: string; street: string }>();
        expectTypeOf<
            FlattenProperties<
                { name: string; address: { street: string; avenue: string } },
                "address"
            >
...
describe("PublicOnly", () => {
    test("Remove properties beginning with (_)", () => {
        expectTypeOf<PublicOnly<{ foo: string }>>().toEqualTypeOf<{
            foo: string;
        }>();
        expectTypeOf<
            PublicOnly<{ foo: string; _bar: string }>
        >().toEqualTypeOf<{ foo: string }>();
        expectTypeOf<
            PublicOnly<{ _foo: string; _bar: string }>
        >().toEqualTypeOf<{}>();
    });
});
...
describe("RetrieveKeyValue", () => {
    test("Exist the key within objects", () => {
        expectTypeOf<
            RetrieveKeyValue<{ foo: string }, { bar: number }, "foo">
        >().toEqualTypeOf<string>();
        expectTypeOf<
            RetrieveKeyValue<{ foo: string }, { bar: number }, "bar">
        >().toEqualTypeOf<number>();
        expectTypeOf<
            RetrieveKeyValue<{ foo: string }, { foo: number }, "foo">
        >().toEqualTypeOf<string>();
        expectTypeOf<
            RetrieveKeyValue<{ foo: string }, { foo: number }, "foobar">
        >().toEqualTypeOf<never>();
    });
});
...
describe("RequiredByKeys", () => {
    test("Convert required properties in an object", () => {
        expectTypeOf<
            RequiredByKeys<{ foo?: string; bar?: number }, "foo">
        >().toEqualTypeOf<{ foo: string; bar?: number }>();
        expectTypeOf<
            RequiredByKeys<{ foo?: string; bar?: number }, "bar">
        >().toEqualTypeOf<{ foo?: string; bar: number }>();
        expectTypeOf<
            RequiredByKeys<{ foo?: string; bar?: number }>
        >().toEqualTypeOf<{ foo: string; bar: number }>();
    });
});
...
describe("UnionMerge", () => {
    test("Merge the types of the properties of two objects.", () => {
        expectTypeOf<
            UnionMerge<{ foo: string }, { bar: string }>
        >().toEqualTypeOf<{ foo: string; bar: string }>();
        expectTypeOf<
            UnionMerge<{ foo: string }, { foo: number }>
        >().toEqualTypeOf<{ foo: string | number }>();
        expectTypeOf<
            UnionMerge<{ foo: string | number }, { foo: boolean }>
        >().toEqualTypeOf<{ foo: string | number | boolean }>();
    });
});

describe("Mutable", () => {
    test("Converts properties to non readonly only one level", () => {
        expectTypeOf<Mutable<{ readonly foo: string }>>().toEqualTypeOf<{
            foo: string;
        }>();
        expectTypeOf<
            Mutable<{
...
describe("DeepMutable", () => {
    test("Converts all properties to non readonly of an object type", () => {
        ...
        expectTypeOf<
            DeepMutable<DeepReadonly<{ foo: string }>>
        >().toEqualTypeOf<{ foo: string }>();
        expectTypeOf<
            DeepMutable<DeepReadonly<{ foo: { bar: number } }>>
        >().toEqualTypeOf<{ foo: { bar: number } }>();
        expectTypeOf<
            DeepMutable<DeepReadonly<{ foo: { bar: { foobar: number } } }>>
        >().toEqualTypeOf<{ foo: { bar: { foobar: number } } }>();
        expectTypeOf<
            DeepMutable<
                DeepReadonly<{ foo: [{ bar: string; foobar: number }] }>
            >
        >().toEqualTypeOf<{ foo: [{ bar: string; foobar: number }] }>();
...
describe("MergeAll", () => {
    test("Merge the properties of a tuple of objects", () => {
        expectTypeOf<
            MergeAll<[{ foo: string }, { bar: number }]>
        >().toEqualTypeOf<{ foo: string; bar: number }>();
        expectTypeOf<
            MergeAll<[{ foo: string }, { bar: { foobar: number } }]>
        >().toEqualTypeOf<{ foo: string; bar: { foobar: number } }>();
        type Expect3 = {
            foo: string | boolean;
            bar: number | string;
            foobar: string;
        ...
        expectTypeOf<
            MergeAll<
                [
                    { foo: string },
                    { bar: string },
                    { bar: number; foo: boolean; foobar: string },
                ]
            >
...
describe("ToUnion", () => {
    test("Create an union type", () => {
        ...
        expectTypeOf<ToUnion<[12, 21, "foo"]>>().toEqualTypeOf<
            12 | 21 | "foo" | []
        >();
    });
});
...
describe("AddPropertyToObject", () => {
    test("Append a new property of an exist object type", () => {
        expectTypeOf<
            AddPropertyToObject<{ foo: string }, "bar", number>
        >().toEqualTypeOf<{ foo: string; bar: number }>();
        expectTypeOf<
            AddPropertyToObject<
                { foo: string },
                "bar",
                { foobar: number; barfoo: boolean }
            >
        >().toEqualTypeOf<{
            foo: string;
        ...
        expectTypeOf<
            AddPropertyToObject<{ foo: string }, "bar", [1, 2, 3]>
        >().toEqualTypeOf<{ foo: string; bar: [1, 2, 3] }>();
        expectTypeOf<
            AddPropertyToObject<
                { foo: string },
                "bar",
            ...
            >
        >().toEqualTypeOf<{ foo: string; bar: string | boolean | number }>();
    });
});
...
describe("Intersection", () => {
    test("Intersection of properties between two objects", () => {
        expectTypeOf<
            Intersection<{ foo: string }, { foo: number; bar: boolean }>
        >().toEqualTypeOf<{ bar: boolean }>();
        expectTypeOf<
            Intersection<
                { foo: string; bar: boolean },
                { bar: number; foo: bigint }
            >
        >().toEqualTypeOf<{}>();
        expectTypeOf<
            Intersection<
                { foo: string; bar: { bar: number } },
                { barfoo: { bar: number }; foo: bigint }
            >
...
describe("Tuple methods", () => {
    ...
    describe("Pop", () => {
        test("Remove the last element of a tuple", () => {
            ...
            expectTypeOf<Pop<["foo", "bar", "foobar"]>>().toEqualTypeOf<
                ["foo", "bar"]
            >();
        });
    });
    ...
    describe("Filter", () => {
        test("Filter the elements based in the predicate", () => {
            ...
            expectTypeOf<Filter<[0, 1, 2, 3, 4], 0 | 4>>().toEqualTypeOf<
                [0, 4]
            >();
            expectTypeOf<Filter<[0, 0, 1, 1, 1], 1>>().toEqualTypeOf<
                [1, 1, 1]
            >();
            expectTypeOf<
                Filter<["foo", "bar", "foobar"], "bar">
            >().toEqualTypeOf<["bar"]>();
        });
    });
    ...
    describe("FilterOut", () => {
        test("Removes the elements present in the predicate", () => {
            expectTypeOf<FilterOut<[1, 2, 3, 4, 5], [4, 5]>>().toEqualTypeOf<
                [1, 2, 3]
            >;
            expectTypeOf<FilterOut<["foo", "bar", "foobar"], "foo">>()
                .toEqualTypeOf<["bar", "foobar"]>;
            expectTypeOf<FilterOut<["foo", "bar", "foobar", 1, 2], "foo" | 2>>()
                .toEqualTypeOf<["bar", "foobar", 1]>;
            expectTypeOf<
                FilterOut<
                    [{ foo: string }, { bar: number }, { foobar: boolean }],
                    { bar: number }
                >
            >().toEqualTypeOf<[{ foo: string }, { foobar: boolean }]>;
            expectTypeOf<
                FilterOut<
                    ["foo", "bar", "foobar", 1, 2, { foo: string }],
                    { foo: string }
                >
    ...
    describe("Reverse", () => {
        test("Reverse the elements of a tuple type", () => {
            ...
            expectTypeOf<Reverse<["a", "b", "c"]>>().toEqualTypeOf<
                ["c", "b", "a"]
            >();
            expectTypeOf<
                Reverse<[1, "foo", 2, "bar", { foo: number }, () => void]>
            >().toEqualTypeOf<
...
describe("PercentageParser", () => {
    test("Parses a percentage string into a tuple", () => {
        ...
        expectTypeOf<PercentageParser<"2024">>().toEqualTypeOf<
            ["", "2024", ""]
        >();
        expectTypeOf<PercentageParser<"-89">>().toEqualTypeOf<
            ["-", "89", ""]
        >();
        expectTypeOf<PercentageParser<"+89%">>().toEqualTypeOf<
            ["+", "89", "%"]
...
describe("Omit Properties", () => {
    describe("Omit", () => {
        test("Omit the properties based on the key type", () => {
            ...
            expectTypeOf<
                Omit<{ foo: string; bar: number }, "foo">
            >().toEqualTypeOf<{ bar: number }>();
            expectTypeOf<
                Omit<{ foo: () => void; bar: { foobar: number } }, "foo">
            >().toEqualTypeOf<{ bar: { foobar: number } }>();
        });
    });
    ...
    describe("OmitByType", () => {
        test("Omit the properties based on the type", () => {
            expectTypeOf<
                OmitByType<{ foo: string; bar: string; foobar: number }, string>
            >().toEqualTypeOf<{ foobar: number }>();
            expectTypeOf<
                OmitByType<
                    { foo: string; bar: number; foobar: boolean },
                    string | boolean
...
describe("Parameters", () => {
    test("Returns the parameters of a function", () => {
        ...
        expectTypeOf<Parameters<(foo: string) => void>>().toEqualTypeOf<
            [string]
        >();
        expectTypeOf<
            Parameters<(foo: string, bar: number) => void>
        >().toEqualTypeOf<[string, number]>();
        expectTypeOf<
            Parameters<(foo: { bar: number }) => void>
        >().toEqualTypeOf<[{ bar: number }]>();
    });
});
...
describe("Includes", () => {
    test("Check if an element exist withins a tuple", () => {
        ...
        expectTypeOf<
            Includes<["foo", "bar", () => void, {}], () => void>
        >().toEqualTypeOf<true>();
        expectTypeOf<
            Includes<[string, 1, () => void, {}], string>
        >().toEqualTypeOf<true>();
        expectTypeOf<
            Includes<[string, number, () => void, {}], number>
        >().toEqualTypeOf<true>();
        expectTypeOf<
            Includes<[true, false, true], number>
        >().toEqualTypeOf<false>();
    });
});
...
describe("ConstructTuple", () => {
    test("Create a tuple with a defined size", () => {
        ...
        expectTypeOf<ConstructTuple<2, string>>().toEqualTypeOf<
            [string, string]
        >();
        expectTypeOf<ConstructTuple<5, any>>().toEqualTypeOf<
            [any, any, any, any, any]
        >();
    });
});
...
describe("CheckRepeatedTuple", () => {
    test("Check if there are duplicated elements", () => {
        ...
        expectTypeOf<
            CheckRepeatedTuple<["foo", "bar", 1, 5]>
        >().toEqualTypeOf<false>();
        expectTypeOf<
            CheckRepeatedTuple<[() => void, () => void]>
        >().toEqualTypeOf<true>();
        expectTypeOf<
            CheckRepeatedTuple<[{ foo: string }, { foo: string }]>
        >().toEqualTypeOf<true>();
    });
});
...
describe("Absolute", () => {
    test("Returns the absolute version of a number", () => {
        ...
        expectTypeOf<
            Absolute<-999_999_999_999>
        >().toEqualTypeOf<"999999999999">();
        expectTypeOf<
            Absolute<-999_999_999_999_999n>
        >().toEqualTypeOf<"999999999999999">();
    });
});

describe("ObjectEntries", () => {
    test("Returns the entries from an object", () => {
        expectTypeOf<ObjectEntries<{ foo: string }>>().toEqualTypeOf<
            ["foo", string]
        >();
        expectTypeOf<ObjectEntries<{ foo?: string }>>().toEqualTypeOf<
            ["foo", string]
        >();
        expectTypeOf<
            ObjectEntries<{ foo?: string; bar?: number }>
        >().toEqualTypeOf<["foo", string] | ["bar", number]>();
        expectTypeOf<
            ObjectEntries<{ foo?: undefined; bar: undefined | string }>
        >().toEqualTypeOf<["foo", undefined] | ["bar", undefined | string]>();
    });
});
...
describe("AllEquals", () => {
    test("Check if all elements are equal", () => {
        ...
        expectTypeOf<
            AllEquals<[number, number, number, number], number>
        >().toEqualTypeOf<true>();
...
describe("Pick Utilities", () => {
    describe("Pick", () => {
        test("Pick by keys", () => {
            expectTypeOf<
                Pick<{ foo: string; bar: number }, never>
            >().toEqualTypeOf<{}>();
            expectTypeOf<
                Pick<{ foo: string; bar: number }, "bar">
            >().toEqualTypeOf<{ bar: number }>();
            expectTypeOf<
                Pick<{ foo: string; bar: number }, "bar" | "foo">
            >().toEqualTypeOf<{ foo: string; bar: number }>();
        });
    });
    ...
    describe("PickByType", () => {
        test("Pick by type", () => {
            expectTypeOf<
                PickByType<{ foo: string; bar: number; foofoo: string }, number>
            >().toEqualTypeOf<{ bar: number }>();
            expectTypeOf<
                PickByType<{ foo: string; bar: number; foofoo: string }, string>
            >().toEqualTypeOf<{ foo: string; foofoo: string }>();
            expectTypeOf<
                PickByType<{ foo: () => {}; bar: number }, string>
            >().toEqualTypeOf<{}>();
            expectTypeOf<
                PickByType<{ foo: () => {}; bar: number; foobar: {} }, never>
            >().toEqualTypeOf<{}>();
            expectTypeOf<
                PickByType<{ foo: () => {}; bar: number; foobar: {} }, () => {}>
            >().toEqualTypeOf<{ foo: () => {} }>();
        });
    });
});
