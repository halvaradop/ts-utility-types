 ...
 */
export type TupleToUnion<Array extends readonly unknown[]> = Array extends [
    infer Item,
    ...infer Spread,
]
 ...
 */
export type Parameters<Function extends ArgsFunction> = Function extends (
    ...args: infer Params
) => void
    ? Params
    : never
 ...
 */
export type Includes<Array extends unknown[], Match> = Array extends [
    infer Compare,
    ...infer Spread,
]
 ...
 */
export type CheckRepeatedTuple<
    Array extends unknown[],
    Build extends unknown = "",
> = Array extends [infer Item, ...infer Spread]
    ? Item extends Build
...
export type ObjectEntries<
    Obj extends object,
    RequiredObj extends object = Required<Obj>,
> = {
    [Property in keyof RequiredObj]: [
        Property,
 ...
 */
export type AllEquals<Array extends unknown[], Comparator> = Array extends [
    infer Item,
    ...infer Spread,
]
